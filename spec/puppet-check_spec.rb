...
describe PuppetCheck do
  ...
  context '.output_results_text' do
    before(:each) do
    ...
    it 'outputs files with errors' do
      ...
      expect { PuppetCheck.output_results_text }.to output("\033[31mThe following files have errors:\033[0m\n-- foo: i had an error\n").to_stdout
    end
    it 'outputs files with warnings' do
      PuppetCheck.warning_files = ['foo: i had a warning']
      expect { PuppetCheck.output_results_text }.to output("\n\033[33mThe following files have warnings:\033[0m\n-- foo: i had a warning\n").to_stdout
    end
  ...
  context '.output_results_yaml' do
    before(:each) do
      PuppetCheck.error_files = []
      PuppetCheck.warning_files = []
      PuppetCheck.clean_files = []
    ...
    it 'outputs files with errors' do
      PuppetCheck.error_files = ['foo: i had an error']
      expect { PuppetCheck.output_results_yaml }.to output("---\nerrors:\n- 'foo: i had an error'\n").to_stdout
    end
    it 'outputs files with warnings' do
      PuppetCheck.warning_files = ['foo: i had a warning']
      expect { PuppetCheck.output_results_yaml }.to output("---\nwarnings:\n- 'foo: i had a warning'\n").to_stdout
  ...
  context '.output_results_json' do
    before(:each) do
      PuppetCheck.error_files = []
      PuppetCheck.warning_files = []
      PuppetCheck.clean_files = []
    ...
    it 'outputs files with errors' do
      PuppetCheck.error_files = ['foo: i had an error']
      expect { PuppetCheck.output_results_json }.to output("{\n  \"errors\": [\n    \"foo: i had an error\"\n  ]\n}\n").to_stdout
    end
    it 'outputs files with warnings' do
      PuppetCheck.warning_files = ['foo: i had a warning']
      expect { PuppetCheck.output_results_json }.to output("{\n  \"warnings\": [\n    \"foo: i had a warning\"\n  ]\n}\n").to_stdout
